return {
  {
    ...
    event = {
      ...
      'BufReadPre '
        .. vim.fn.expand '~'
        .. '/Repos/commonplace/**.md',
      'BufNewFile ' .. vim.fn.expand '~' .. '/Repos/commonplace/20-Inbox/**.md',
    },
    dependencies = {
      -- Required.
    ...
    opts = {
      ...
      dir = '~/Repos/commonplace', -- no need to call 'vim.fn.expand' here
